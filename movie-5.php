...
<body>
    ...
    <section id="portfolio-information" class="padding-top">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img src="images/movies/blackwidow.jpg" class="img-responsive" alt="" width="400" height="200">
                </div>
                <div class="col-sm-6">
                    <div class="project-info overflow">
                        <h1 class="own">Black Widow</h1>
                        <h3>At birth the Black Widow (aka Natasha Romanova) is given to the KGB, which grooms her to become its ultimate operative. When the U.S.S.R. breaks up, the government tries to kill her as the action moves to present-day New York, where she is a freelance operative.</h3>
                        <ul class="elements">
                            <li><i class="fa fa-angle-right"></i>2019 ‧ Action/Sci-fi ‧ 3h 2m</li>
                            
                            <li><i class="fa fa-angle-right"></i>Scarlett Johansson . Florence Pugh . David Harbour</li>
                        </ul>
                    </div>
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT availability from showtime where showtime_id='S0BW20210614'";
 ...
 $connection = oci_connect(
    ...
    <div class="live-preview">
                    ...
                    <input type="hidden" name="Item_Name" value="Black Widow">
