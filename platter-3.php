...
<div class="container">
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT food_name from food where food_name='Platter-3'";
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT price from food where food_name='Platter-3'";
    $result = oci_parse($connection, $query);
    oci_execute($result);
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
                            foreach ($row as $item) {
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT platter_size from food where food_name='Platter-3'";
    $result = oci_parse($connection, $query);
    oci_execute($result);
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
                            foreach ($row as $item) {
