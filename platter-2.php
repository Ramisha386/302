...
<div class="container">
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT food_name from food where food_name='Platter-2'";
    ...
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
               ...
               ?>
                        ...
                        <ul class="elements">
                            <li><i class="fa fa-angle-right"></i> 1 King Size Burger</li>
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT price from food where food_name='Platter-2'";
    $result = oci_parse($connection, $query);
    oci_execute($result);
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
                            foreach ($row as $item) {
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT platter_size from food where food_name='Platter-2'";
    $result = oci_parse($connection, $query);
    oci_execute($result);
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
                            foreach ($row as $item) {
               ...
               ?>
                    ...
                    <input type="hidden" name="Item_Name" value="Platter-2">
