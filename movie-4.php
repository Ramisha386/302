...
<body>
    ...
    <section id="portfolio-information" class="padding-top">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img src="images/movies/avengers.jpg" class="img-responsive" alt="" width="400" height="200">
                </div>
                <div class="col-sm-6">
                    <div class="project-info overflow">
                        <h1 class="own">Avengers: Endgame</h1>
                        <h3>After Thanos, an intergalactic warlord, disintegrates half of the universe, the Avengers must reunite and assemble again to reinvigorate their trounced allies and restore balance.</h3>
                        <ul class="elements">
                            <li><i class="fa fa-angle-right"></i>2019 ‧ Action/Sci-fi ‧ 3h 2m</li>
                            
                            <li><i class="fa fa-angle-right"></i>Robert Downey . Jr.Chris Evans . Mark Ruffalo</li>
                        </ul>
                    </div>
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT availability from showtime where showtime_id='S0AE20210614'";
 ...
 $connection = oci_connect(
    ...
    <div class="live-preview">
                    ...
                    <input type="hidden" name="Item_Name" value="Avengers: Endgame">
