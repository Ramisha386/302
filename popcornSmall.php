...
<body>
    ...
    <section id="portfolio-information" class="padding-top">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img src="images/portfolio-details/6.jpg" class="img-responsive" alt="">
                </div>
                <div class="col-sm-6">
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT food_name from food where food_name='Popcorn Small'";
    ...
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
               ...
               ?>
                        ...
                        <ul class="elements">
                            <li><i class="fa fa-angle-right"></i> 1 Small Popcorn</li>
                        </ul>
                    </div>
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT price from food where food_name='Popcorn Small'";
    $result = oci_parse($connection, $query);
    oci_execute($result);
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
                            foreach ($row as $item) {
 ...
 $connection = oci_connect(
    ...
    $query = "SELECT platter_size from food where food_name='Popcorn Small'";
    $result = oci_parse($connection, $query);
    oci_execute($result);
    while ($row = oci_fetch_array($result, OCI_ASSOC + OCI_RETURN_NULLS)) { 
                            foreach ($row as $item) {
               ...
               ?>
                    ...
                    <input type="hidden" name="Item_Name" value="Popcorn Small">
